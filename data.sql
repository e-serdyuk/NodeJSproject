...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 17 2017 г., 17:27
...
(37, 'Title_edited', 'Author_edited', 'red|red_text', 'Web', 'uploads/IMG_20160504_181857.jpg', '2017-07-17');

-- --------------------------------------------------------

--
-- Структура таблицы `resetpassword`
--
...
INSERT INTO `users` (`username`, `passwordHash`, `id`) VALUES
('90', 'f44cfe94adfa944d4228ded2b1f61695ba7046ba', 43),
('admin', 'f5eae1f3cb8aa41ea3e64ce73e2f46abc4980d87', 48),
('5621', '960e4ce9f6f09999d523b800a72722d7e85d5736', 67),
('qweqwe', '493d6d9417603568805a056e68fda60d3af4098a', 68),
('tata', '052b66480850dc5e933687ea60f8d0a0e8056421', 70);
